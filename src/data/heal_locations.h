...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 31, 11},
    ...
    [HEAL_LOCATION_PETALBURG_CITY - 1] = {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), 28, 25},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 37, 8},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 37, 8},
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 38, 13},
    ...
    [HEAL_LOCATION_PACIFIDLOG_TOWN - 1] = {MAP_GROUP(PACIFIDLOG_TOWN), MAP_NUM(PACIFIDLOG_TOWN), 36, 13},
    ...
    [HEAL_LOCATION_TANTRAMARSH_TOWN_SEASIDE_OUTPOST_1F - 1] = {MAP_GROUP(TANTRAMARSH_TOWN_SEASIDE_OUTPOST_1F), MAP_NUM(TANTRAMARSH_TOWN_SEASIDE_OUTPOST_1F), 1, 5},
};
