const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_ONIX]       = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_STEELIX}},
    [SPECIES_DROWZEE]    = {{EVO_LEVEL, 7, SPECIES_HYPNO}},
    ...
    [SPECIES_SCYTHER]    = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_SCIZOR}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_HUNTAIL},
    ...
    [SPECIES_SHELGON]    = {{EVO_LEVEL, 24, SPECIES_SALAMENCE}},
